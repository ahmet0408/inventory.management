        ...
        <div className="row g-3">
          ...
          <div className="col-auto flex-grow-1 overflow-auto">
            <div className="btn-group position-static">
              <div className="btn-group position-static">
                <button type="button" className="btn border btn-filter dropdown-toggle px-4" data-bs-toggle="dropdown" aria-expanded="false">
                  Payment Status
                </button>
          ...
          <div className="col-auto">
            <div className="d-flex align-items-center gap-2 justify-content-lg-end">
               ...
               <Link to="/orderdetail">
               <button className="btn btn-primary px-4"><i className="bi bi-plus-lg me-2"></i>Täze sargyt</button></Link>
            </div>
          </div>
        </div>
                       ...
                       <td>
                        <a className="d-flex align-items-center gap-3" href="javascript:;">
                          <div className="customer-pic">
                            <img src="assets/images/avatars/01.png" className="rounded-circle" width="40" height="40" alt="" />
                          </div>
                          <p className="mb-0 customer-name fw-bold">Andrew Carry</p>
                        </a>
                       </td>
                       <td><span className="lable-table bg-success-subtle text-success rounded border border-success-subtle font-text2 fw-bold">Completed<i className="bi bi-check2 ms-2"></i></span></td>
                       <td><span className="lable-table bg-danger-subtle text-danger rounded border border-danger-subtle font-text2 fw-bold">Failed<i className="bi bi-x-lg ms-2"></i></span></td>
