          ...
          <div className="card-body">
              <div className="d-flex flex-lg-row flex-column align-items-start align-items-lg-center justify-content-between gap-3">
                 <div className="flex-grow-1">
                   ...
                   <p className="mb-0">Müşderi ID : <a href="javascript:;">6589743</a></p>
                 </div>
                 <div className="overflow-auto">
                  <div className="btn-group position-static">
                    ...
                    <div className="btn-group position-static">
                      <button type="button" className="btn btn-outline-primary">
                        <i className="bi bi-arrow-clockwise me-2"></i>Yzyna gaýtarmak
                      </button>
         ...
         <div className="row">
            <div className="col-12 col-lg-8 d-flex">
               <div className="card w-100">
                <div className="card-body">
                  <h5 className="mb-3 fw-bold">Sargyt harytlar<span className="fw-light ms-2">(46)</span></h5>
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    <p className="mb-0 fw-bold">Items subtotal :</p>
                    <p className="mb-0 fw-bold">$8495</p>
                  </div>
                </div>
               </div>
            </div>
                ...
                <div className="col">
                  <div className="d-flex align-items-start gap-3 border p-3 rounded">
                    ...
                    <div className="detail-info">
                       ...
                       <a href="javascript:;" className="mb-0">Jhon Maxwell</a>
                    </div>
                 </div>
                </div>
                ...
                <div className="col">
                  <div className="d-flex align-items-start gap-3 border p-3 rounded">
                    ...
                    <div className="detail-info">
                      ...
                      <a href="javascript:;" className="mb-0">abcexample.com</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="col">
                  <div className="d-flex align-items-start gap-3 border p-3 rounded">
                    ...
                    <div className="detail-info">
                      ...
                      <a href="javascript:;" className="mb-0">+01-585XXXXXXX</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="col">
                  <div className="d-flex align-items-start gap-3 border p-3 rounded">
                    ...
                    <div className="detail-info">
                      ...
                      <p  className="mb-0">198 Street Name, City, Inited States of America</p>
                    </div>
                  </div>
                </div>
              </div>
